...
// set will distinguish seperated array
...
console.log(orderSet.has('Nonny'))
orderSet.add('Garlic Bread')
orderSet.add('Garlic Bread')
// orderSet.delete('Risotto')
// orderSet.clear()
console.log(orderSet) //it can not retrieve 
...
console.log(new Set('hduwahsadwazcxfayuykyduhwaudwa').size)//output 12 seperated 